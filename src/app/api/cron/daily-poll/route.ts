...
// Configure an every-minute cron (e.g. Vercel Cron) to hit this as a backup, OR
// rely on the worker's internal 30-second scheduler loop. Poll jobs are bucketed
// every 30 seconds during each agent's call window.
// =====================================================================
